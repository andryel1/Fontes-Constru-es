...
public static class PagamentoMessages
{
    private static readonly ResourceManager resourceManager =
        new("Resources.Messages.PagamentoMessages", typeof(PagamentoMessages).Assembly);
    ...
    public static string ParcelamentoObrigatorio =>
        resourceManager.GetString("ParcelamentoObrigatorio", CultureInfo.CurrentUICulture) ?? "[ParcelamentoObrigatorio]";
    ...
    public static string PedidosMin1 =>
        resourceManager.GetString("PedidosMin1", CultureInfo.CurrentUICulture) ?? "[PedidosMin1]";
} 